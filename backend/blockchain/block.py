...
class Block:
    ...
    def to_json(self):
        """
        Serialize block into dict of its attributes
        """
    ...
    def is_valid_block(last_block, block):
        ...
        -block musthave proper last_hash ref
        -block must meet the proof of work req
        -difficulty must only adjust by 1
        -block has must be a valid has of the block fields
        """
